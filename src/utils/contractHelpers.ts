...
import leosStakingAbi from 'config/abi/leosStakingAbi.json'
...
export const getLeosStakingContract = (signer?: ethers.Signer | ethers.providers.Provider) => {
