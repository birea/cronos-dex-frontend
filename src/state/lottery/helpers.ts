...
const processViewLotterySuccessResponse = (response, lotteryId: string): LotteryResponse => {
  ...
  const serializedCakePerBracket = salePerBracket.map((cakeInBracket) => ethersToSerializedBigNumber(cakeInBracket))
  ...
  const data  =  {
    ...
    priceTicketInCake: ethersToSerializedBigNumber(priceTicketInSale),
    discountDivisor: discountDivisor?.toString(),
    treasuryFee: treasuryFee?.toString(),
    firstTicketId: firstTicketId?.toString(),
    lastTicketId: lastTicketId?.toString(),
    amountCollectedInCake: ethersToSerializedBigNumber(amountCollectedInSale),
    finalNumber,
