...
const PredictionPromotionCard = () => {
  ...
  return (
    <StyledPredictionCard>
      <CardBody>
        <PredictionLive mb="24px">{t('Predictions (coming soon)')}</PredictionLive>
        ...
        <PredictionWon mb="24px" color="primary" bold prefix="$" decimals={0} value={189564} />
        ...
        {/* <Link href="https://pancakeswap.finance/prediction" id="homepage-prediction-cta"> */}
          <Button px={['14px', null, null, null, '20px']} disabled>
            <PredictionTryNow>
