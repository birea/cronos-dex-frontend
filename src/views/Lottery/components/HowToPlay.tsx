  ...
  return (
    <StyledStepCard width="100%">
      <StepCardInner height={['200px', '180px', null, '200px']}>
        <Text mb="16px" fontSize="12px" bold textAlign="right" textTransform="uppercase" color="primary">
          {step.label}
        </Text>
        <Heading mb="16px" scale="lg" color="text">
          {step.title}
        </Heading>
    ...
    <StyledStepCard width={['280px', '330px', '380px']}>
      <StepCardInner height="220px">
        <MatchExampleContainer>
          ...
          <MatchExampleA width={exampleWidth} height="46px" isDark />
          <Text lineHeight="72px" textAlign="right" color="primary" bold mr="20px">
            {t('B')}
          </Text>
          <MatchExampleB width={exampleWidth} height="46px" isDark />
        </MatchExampleContainer>
      </StepCardInner>
    </StyledStepCard>
  )
  ...
  return (
    <StyledStepCard width={['280px', '330px', '380px']}>
      <StepCardInner height="420px">
        ...
        <AllocationGrid>
          <AllocationMatch color="#FF5722" text={t('Matches first %digits%', { digits: 1 })} />
          <Text textAlign="right" bold>
            1%
          </Text>
          <AllocationMatch color="#FFC108" text={t('Matches first %digits%', { digits: 2 })} />
          <Text textAlign="right" bold>
            3%
          </Text>
          <AllocationMatch color="#8BC44A" text={t('Matches first %digits%', { digits: 3 })} />
          <Text textAlign="right" bold>
            6%
          </Text>
          <AllocationMatch color="#03A9F4" text={t('Matches first %digits%', { digits: 4 })} />
          <Text textAlign="right" bold>
            10%
          </Text>
          <AllocationMatch color="#3F51B5" text={t('Matches first %digits%', { digits: 5 })} />
          <Text textAlign="right" bold>
            20%
          </Text>
          <AllocationMatch color="#EA1E62" text={t('Matches all 6')} />
          <Text textAlign="right" bold>
            40%
          </Text>
          <AllocationMatch color="#303742" text={t('Burn Pool')} />
          <Text textAlign="right" bold>
            20%
          </Text>
        </AllocationGrid>
  ...
  const steps: Step[] = [
    {
      ...
      title: t('Buy Tickets'),
      subtitle: t('Prices are set when the round starts, equal to 5 USD in SALE per ticket.'),
    },
    {
    ...
    },
    {
      ...
      subtitle: t('Once the round is over, come back to the page and check to see if you’ve won!'),
    },
  ]
  return (
    <Box width="100%">
      ...
      <GappedFlex flexDirection={['column', 'column', 'column', 'row']}>
        <Flex flex="2" flexDirection="column">
          <Heading mb="24px" scale="lg" color="primary">
            {t('Winning Criteria')}
          </Heading>
        ...
        <Flex flex="1" justifyContent="center">
          {/* <MatchExampleCard /> */}
          <img src="/images/lottery/criteria.svg" alt="criteria card" />
        </Flex>
      </GappedFlex>
      <Divider />
      <GappedFlex flexDirection={['column', 'column', 'column', 'row']}>
        <Flex flex="2" flexDirection="column">
          ...
          <BulletList>
            <li>
              <Text display="inline" color="textSubtle">
                {t('100% of the SALE paid by people buying tickets that round goes back into the prize pools.')}
              </Text>
            </li>
          </BulletList>
          <Heading my="16px" scale="md">
          ...
          <BulletList>
            <li>
              <Text display="inline" color="textSubtle">
                {t(
                  'After every round, if nobody wins in one of the prize brackets, the unclaimed SALE for that bracket rolls over into the next round and are redistributed among the prize pools.',
                )}
              </Text>
            </li>
          </BulletList>
          ...
          <BulletList>
            <li>
              <Text display="inline" color="textSubtle">
                {t(
                  '10,000 SALE from the treasury is added to a lottery round every other day. This SALE is of course also included in rollovers! Read more in our guide to ',
                )}
