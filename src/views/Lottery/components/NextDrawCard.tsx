...
const NextDrawCard = () => {
  ...
  return (
    <StyledCard>
      <CardHeader p="16px 24px" variant='blue'>
        <Flex justifyContent="space-between">
          <Heading mr="12px" color='background'>{t('Next Draw')}</Heading>
      ...
      <CardFooter p="0">
        ...
        {(status === LotteryStatus.OPEN || status === LotteryStatus.CLOSE) && (
          <Flex p="8px 24px" alignItems="center" justifyContent="center" background='white'>
