...
import { Button, Heading, Flex, useModal, AutoRenewIcon } from 'toolkit/uikit'
...
const Container = styled(Flex)`
  width: 100%;
  // background-image: url('/images/lottery/bottom-ball.svg');
  // background
  ${({ theme }) => theme.mediaQueries.sm} {
    width: 520px;
  }
...
const CheckPrizesSection = () => {
  ...
  const getBody = () => {
    if (!account) {
      return (
        <Flex alignItems="center" justifyContent="center">
          <TicketImage src="/images/lottery/b3.svg" alt="lottery ticket" />
          ...
          <TicketImage src="/images/lottery/b4.svg" alt="lottery ticket" />
        </Flex>
      )
    }
    if (hasCheckedForRewards && !hasRewardsToClaim) {
      return (
        <Flex alignItems="center" justifyContent="center">
          <TornTicketImage src="/images/lottery/broken-ticket-left.svg" alt="torn lottery ticket" />
          ...
          <TornTicketImage src="/images/lottery/broken-ticket-right.svg" alt="torn lottery ticket" />
        </Flex>
      )
    }
    if (hasCheckedForRewards && hasRewardsToClaim) {
    ...
    return (
      <Container alignItems="center" justifyContent="space-between" width={['100%', '756px']}>
        <img src="/images/lottery/left-ball.svg" alt="lottery ticket" style={{ marginTop: '-100px' }} />
        <Flex mx={['4px', null, '16px']} flexDirection="column">
          <Heading textAlign="center" color="#F4EEFF" mb="24px">
            {t('Are you a winner?')}
          </Heading>
          ...
          <img src="/images/lottery/mid-ball.svg" alt="lottery ticket" style={{position:'absolute', bottom:'0px', left:'50%'}} />
        </Flex>
        <img src="/images/lottery/right-ball.svg" alt="lottery ticket" style={{ width: '50ox', marginTop: '-150px' }} />
      </Container>
    )
  }
