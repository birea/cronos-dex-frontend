...
import { Svg, SvgProps, Text, Flex } from 'toolkit/uikit'
...
export const BallWithNumber: React.FC<BallWithNumberProps> = ({ color, number, size, fontSize, rotationTransform }) => {
  ...
  switch (color) {
    case 'pink':
      src = 'images/lottery/ball1.svg'
      break

    case 'lilac':
      src = 'images/lottery/ball2.svg'
      break

    case 'teal':
      src = 'images/lottery/ball3.svg'
      break

    case 'aqua':
      src = 'images/lottery/ball4.svg'
      break

    case 'green':
      src = 'images/lottery/ball5.svg'
      break

    case 'yellow':
      src = 'images/lottery/ball6.svg'
      break
    default:
      break
  }
  return (
    <Flex alignItems="center" justifyContent="center" position="relative" mx="2px">
       ...
       */}
      <img src={src} alt="ball" width={size ?? '32px'} height={size ?? '32px'} />
      <BallTextWrapper>
