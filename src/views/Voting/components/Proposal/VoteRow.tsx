...
import { Flex, LinkExternal, Text, Tag, CheckmarkCircleIcon } from 'toolkit/uikit'
    ...
    <Row>
      <AddressColumn>
        <Flex alignItems="center">
          <LinkExternal href={getCronosExplorerLink(vote.voter, 'address')}>{truncateWalletAddress(vote.voter)}</LinkExternal>
          {isVoter && (
