...
import { Box, Card, CardBody, CardHeader, Flex, Heading, LinkExternal, Text } from 'toolkit/uikit'
    ...
    <Card mb="16px">
      ...
      <CardBody>
        ...
        <Flex alignItems="center" mb="8px">
          ...
          <LinkExternal href={getCronosExplorerLink(proposal.author, 'address')} ml="8px">
            {truncateWalletAddress(proposal.author)}
          </LinkExternal>
        </Flex>
        <Flex alignItems="center" mb="16px">
          <Text color="textSubtle">{t('Snapshot')}</Text>
          <LinkExternal href={getCronosExplorerLink(proposal.snapshot, 'block')} ml="8px">
            {proposal.snapshot}
          </LinkExternal>
        </Flex>
        <DetailBox p="16px">
