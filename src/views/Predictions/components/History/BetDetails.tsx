...
import { Flex, Text, Link, Heading } from 'toolkit/uikit'
  ...
  return (
    <StyledBetDetails>
      ...
      <Flex alignItems="center" justifyContent="space-between" mb="8px">
        ...
        <Link href={getCronosExplorerLink(bet.round.lockBlock, 'block')} external>
          {bet.round.lockBlock}
        </Link>
      </Flex>
      <Flex alignItems="center" justifyContent="space-between">
        <Text>{t('Closing Block')}</Text>
        <Link href={getCronosExplorerLink(bet.round.endBlock, 'block')} external>
          {bet.round.endBlock}
        </Link>
      </Flex>
    </StyledBetDetails>
